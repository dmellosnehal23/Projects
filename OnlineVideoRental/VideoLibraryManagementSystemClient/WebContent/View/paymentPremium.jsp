...
<%
	...
	float amount	=Float.parseFloat(sess.getAttribute("dueAmount").toString());
	sess.setAttribute("dueAmount",amount);
...
<div id="templatemo_wrapper">
    ...
    <div class="cleaner"></div>
		...
		<label>Search Movie By:</label>              
	  	<select name="searchBy" id="plan" class="input_field" onchange="showRate()">
    ...
    <div id="templatmeo_content" >
        ...
        <div class="content_section">
				...
				<form id="paymentPremium" method="post" action="paymentPremium" onsubmit="return validatecard()" name="checkout">
					<input type='hidden' name='formname' value='paymentPremium'>
						...
						<table align="center">
							...
							<tr>
								<td><span class="label">Due Amount:</span></td>
								<td><%=amount%></td>
							</tr>
							...
							<tr></tr>
							<tr>
								<td><input type='submit' value='Check Out' align='middle'></td>
							</tr>
						</table>
				</form>
