...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements VideoLibrary.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/VideoLibraryManagementSystem/services/Service";
    ...
    public VideoLibrary.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            VideoLibrary.ServiceSoapBindingStub _stub = new VideoLibrary.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (VideoLibrary.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                VideoLibrary.ServiceSoapBindingStub _stub = new VideoLibrary.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://VideoLibrary", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://VideoLibrary", "Service"));
        }
