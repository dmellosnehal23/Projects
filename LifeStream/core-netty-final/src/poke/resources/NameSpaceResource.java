...
public class NameSpaceResource implements Resource {
	...
	public Response process(Request request) {
		...
		if(request.getHeader().getRoutingId() == eye.Comm.Header.Routing.NAMESPACEADD) {
			try {
		...
		else if (request.getHeader().getRoutingId() == eye.Comm.Header.Routing.NAMESPACEREMOVE) {
			
		}
		else if (request.getHeader().getRoutingId() == eye.Comm.Header.Routing.NAMESPACEUPDATE) {
