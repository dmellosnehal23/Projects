...
public class ClientHandler extends SimpleChannelUpstreamHandler {
	...
	public void handleMessage(eye.Comm.Response msg) {
		//SNE : Print failure msg
		if(msg.getHeader().getReplyCode() == eye.Comm.Header.ReplyStatus.FAILURE) {
			logger.info("FAILURE Response received");
			logger.info(msg.toString());
		}
		else if (msg.getHeader().getRoutingId() == Header.Routing.FINGER) {
