...
public class ResourceFactory {
	...
	public Resource resourceInstance(Header.Routing route) {
		ResourceConf rc = this.getResourceConf(route);
	...
	//SNE : Added method to get access to ResourceConf for a give routing.id
	public ResourceConf getResourceConf(Header.Routing route) {
