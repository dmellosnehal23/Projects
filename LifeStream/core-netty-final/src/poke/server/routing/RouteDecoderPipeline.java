...
//SNE : Same as ServerDecoderPipeline. Added RouteHandler
public class RouteDecoderPipeline implements ChannelPipelineFactory {
	
	private PerChannelQueue pcq;
	
	public RouteDecoderPipeline(PerChannelQueue queue) {
		this.pcq = queue;
	}
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		//SNE : added RouteHandler
		pipeline.addLast("handler", new RouteHandler(this.pcq));
